            ...
            <div className="mx-auto max-w-[1440px] px-4 py-10 sm:px-8 lg:px-10 xl:px-12">
                <section className="rounded-2xl bg-slate-900 px-6 py-8 text-white shadow-lg sm:px-8">
                    ...
                    <div className="mt-4 flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
                        <div>
                            <h1 className="text-3xl font-bold sm:text-4xl">{user?.username}님의 쇼핑 정보</h1>
                            <p className="mt-3 max-w-2xl text-sm leading-6 text-slate-300 sm:text-base">
                                최근 주문, 저장된 배송지, 장바구니 상품을 한곳에서 확인할 수 있습니다.
                            </p>
                        </div>
                ...
                <section className="mt-8 grid gap-6 lg:items-start lg:grid-cols-[1.5fr_1fr]">
                    <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                        <div className="flex items-center justify-between">
                            <div>
                                <h2 className="text-xl font-bold text-slate-900">쇼핑 바로가기</h2>
                                <p className="mt-1 text-sm text-slate-500">
                                    자주 확인하는 항목만 간단하게 모았습니다.
                                </p>
                            </div>
                        ...
                        <div className="mt-6 divide-y divide-slate-100">
                            {[
                                { step: "01", title: "상품 둘러보기", desc: "카테고리와 검색으로 원하는 제품을 빠르게 찾습니다." },
                                { step: "02", title: "장바구니 확인", desc: "담아 둔 상품의 수량과 총 금액을 다시 확인합니다." },
                                { step: "03", title: "결제 진행", desc: "배송지와 결제 수단을 선택한 뒤 주문을 완료합니다." },
                                { step: "04", title: "주문 내역 확인", desc: "완료된 주문을 마이페이지에서 다시 확인할 수 있습니다." },
                            ].map((item) => (
                    ...
                    <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="mt-1 text-sm text-slate-500">결제 시 바로 선택 가능한 주소입니다.</p>
                            </div>
                        </div>
